...
import { asyncUpdateTodo } from "@/states/todos/action";
...
export default function EditTodoForm() {
  ...
  const detailTodo = useAppSelector((state) => state.detailTodo);
  ...
  const form = useForm<z.infer<typeof createNewTodoSchema>>({
    ...
    values: {
      title:
        detailTodo.status === "Success" && detailTodo.data
          ? detailTodo.data.title
          : "",
      description:
        detailTodo.status === "Success" && detailTodo.data
          ? detailTodo.data.description
          : "",
    },
  });
